...
async function runJsonRoundtrip(args, { calibration = false } = {}) {
  ...
  const serialized = JSON.stringify({ unit: expected.unit, layers: expected.layers, entities: expected.entities, blockDefinitions: expected.blockDefinitions, dxfSources: expected.dxfSources });
